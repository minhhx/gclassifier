...
public class Graph{
    ...
    static ArrayList<Node> nodes_test;
    ...
    void GraphBuild(String a, String b){
        
             if(Controller.protid.containsKey(a)==true && Controller.protid.containsKey(b)==true){
                 Node n1 = new Node(); 
                 n1.label = a; 
                 n1.id = Controller.protid.get(a);
                 nodes.add(n1); 
                 int index1 = nodes.size()-1;
                                  
                 Node n2 = new Node();
                 n2.label =b; 
                  n2.id = Controller.protid.get(b);
